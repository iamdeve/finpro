...
router.delete('/deleteRevenue', [auth.Validate, revenueController.deleteRevenueInputValidation], revenueController.deleteRevenueInput);
...
router.delete('/deleteExpense', [auth.Validate, revenueController.deleteExpenseValidation], revenueController.deleteExpense);
...
router.delete('/deleteStartingCapital', [auth.Validate,revenueController.deleteStartingCapitalValidation ], revenueController.deleteStartingCapital);
